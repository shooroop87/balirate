...
?>
    ...
    <head>
        ...
        <?php wp_head(); ?>
            ...
            <link rel="stylesheet" href="<?php echo get_template_directory_uri()?>/css/style.css?ver=<?php echo wp_get_theme()->get( 'Version' );?>">
            <link rel="stylesheet" href="<?php echo get_template_directory_uri()?>/style.css?ver=<?php echo wp_get_theme()->get( 'Version' );?>">
                ...
                <header class="header">
                    <div class="header-top">
                        <div class="header-top__container">
                            <a href="<?php echo get_home_url();?>" aria-label="Ссылка на главную" class="header-bottom__logo"><img src="<?php the_field('logo', 'options'); ?>" class="ibg ibg--contain" alt="logo"></a>
                                    ...
                                    <?php $menu_info = wp_get_nav_menu_items($topmenu_id);?>
                                        <ul class="menu__list">
                                            <?php foreach ($menu_info as $menu) { ?>
                                                <li class="menu__item">
                                                    <a href="<?php echo $menu->url?>" class="menu__link"><?php echo $menu->title?></a>
                                                </li>
                                                <?php } ?>
                                        </ul>
...
<div class="header-lang-switcher">
    <div class="lang-dropdown">
        <button class="lang-current" aria-label="Выбор языка" aria-expanded="false" title="<?php echo esc_attr($language_names[$current_locale] ?? 'Язык') ?>">
            <span class="lang-flag">
                <img src="<?php echo esc_url(plugins_url('translatepress-multilingual/assets/images/flags/' . $current_locale . '.png')) ?>"
                     alt="<?php echo esc_attr($language_names[$current_locale] ?? 'Язык') ?>"
                     width="16" height="16">
            </span>
        </button>
        ...
        <div class="lang-options">
            <?php foreach ($languages as $code => $lang): ?>
                <?php if ($code !== $current_locale): ?>
                    <a href="<?php echo esc_url($language_urls[$code]) ?>" 
                       class="lang-option" 
                       aria-label="<?php echo esc_attr($language_names[$code]) ?>"
                       hreflang="<?php echo esc_attr($code) ?>">
                        <span class="lang-flag">
                            <img src="<?php echo esc_url(plugins_url('translatepress-multilingual/assets/images/flags/' . $code . '.png')) ?>"
                                 alt="<?php echo esc_attr($language_names[$code]) ?>"
                                 width="16" height="16">
                        </span>
                    </a>
                <?php endif; ?>
