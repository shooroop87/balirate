    ...
    <span>Скачать каталог</span>
						...
						if ( is_user_logged_in() ) { ?>
                                    <a href="/wp-login.php?action=logout">
                                        <button type="button" class="header-bottom__popuplink button-login icon-logout"><span><?php the_field('text_logout_'.$lang, 'options'); ?></span>
...
<div class="balirate-catalog-modal" id="catalogModal">
    ...
    <div class="catalog-modal__content">
        <div class="catalog-modal__header">
            <h3 class="catalog-modal__title">Скачать каталог</h3>
