...
/**
 * Исправление ошибки загрузки переводов ACF
 * Решает проблему: "load_textdomain was called incorrectly"
 */
add_action('init', function() {
    // Исправляем загрузку переводов ACF
    if (function_exists('acf_get_setting')) {
        // Удаляем раннюю загрузку переводов если она есть
        remove_action('plugins_loaded', 'acf_load_textdomain');
        
        // Загружаем переводы правильно на хуке init
        $domain = 'acf';
