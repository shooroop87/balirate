...
<section class="videos">
    <div class="videos__container">
        ...
        <div class="videos__slidercont slidercont">
            ...
            <!-- Исправленная навигация слайдера (убран класс icon-arrow-d-b) -->
            <button class="videos__swiper-button-prev swiper-button"></button>
            <button class="videos__swiper-button-next swiper-button"></button>
        </div>
    </div>
</section>
...
/* Дополнительные стили для кнопок навигации */
...
.videos__swiper-button-prev:hover,
.videos__swiper-button-next:hover {
    background: white;
...
/* Стрелки через ::after псевдоэлементы */
...
.videos__swiper-button-next.swiper-button::before {
    display: none;
}
