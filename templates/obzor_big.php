...
<div class="news__top news-topitem">
             <?php if ($filds['image']) { ?>
			 <a href="<?php the_permalink(); ?>"><img src="<?php echo $filds['image']['sizes']['news_big']; ?>" class="ibg" alt="<?php the_title(); ?>" loading="lazy"></a>
			 <?php } ?>
            <div class="news-topitem__content">
              ...
              <?php if ($filds['text_mini']) { ?><div class="news-topitem__text"><?php echo $filds['text_mini']; ?><?php } ?>
              </div>
