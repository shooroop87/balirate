    ...
    (() => {
        ...
        function showMore() {
            window.addEventListener("load", (function(e) {
                ...
                function initItem(showMoreBlock, matchMedia = false) {
                    ...
                    let showMoreButton = showMoreBlock.querySelector("[data-showmore-button]");
                    const showMoreItems = showMoreContent.children.length;
                    const showMoreTypeValue = parseInt(showMoreContent.dataset.showmoreContent, 10) || 3;
                    if (showMoreItems <= showMoreTypeValue) showMoreButton.hidden = true; else {
        ...
        function formRating() {
            ...
            function formRatingInit(rating, ratingSize) {
                ...
                for (let index = 0; index < ratingSize; index++) {
                    ...
                    ratingItems += `\n\t\t\t\t<label class="rating__item">\n\t\t\t\t\t<input class="rating__input" aria-label="Рейтинг-${index + 1}" type="radio" name="rating" value="${index + 1}">\n\t\t\t\t</label>`;
            ...
            function formRatingSet(rating, value) {
                ...
                rating.hasAttribute("data-rating-show") ? rating.insertAdjacentHTML("beforeend", `<span class="rating__showvalue">${rating.dataset.ratingValue}</span>`) : null;
            }
        }
        ...
        function rangeInit() {
            if (document.querySelector("[data-range]")) {
                const myRanges = document.querySelectorAll("[data-range]");
                myRanges.forEach((myRange => {
                    const range = myRange.querySelector("[data-range-slider]");
                    const inputMin = myRange.querySelector("[data-range-min]");
                    const inputMax = myRange.querySelector("[data-range-max]");
                    ...
                    document.addEventListener("change", (function(e) {
                        if (e.target.closest("[data-range-min]")) range.noUiSlider.set([ e.target.closest("[data-range-min]").value, null ]); else if (e.target.closest("[data-range-max]")) range.noUiSlider.set([ null, e.target.closest("[data-range-max]").value ]);
                    }));
                }));
            }
        }
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                new swiper_core_Swiper(".bestagents__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 2,
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".bestagents__swiper-button-prev",
                        nextEl: ".bestagents__swiper-button-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 2,
                ...
                new swiper_core_Swiper(".events__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                new swiper_core_Swiper(".devscomments__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".devscomments__swiper-button-prev",
                        nextEl: ".devscomments__swiper-button-next"
                    },
                    breakpoints: {
                        992: {
                            slidesPerView: 2,
                ...
                if (document.querySelector(".news__slider")) document.querySelectorAll(".news__slider").forEach((swiperContainer => {
                    const parent = swiperContainer.closest(".slidercont");
                    const nextButton = parent.querySelector(".news__swiper-button-next");
                    const prevButton = parent.querySelector(".news__swiper-button-prev");
                ...
                let objectSmallSlider = new swiper_core_Swiper(".object-page__smallslider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 2,
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".object-page__swiper-button-prev",
                        nextEl: ".object-page__swiper-button-next"
                    },
                    breakpoints: {
                        480: {
                            slidesPerView: 2,
                ...
                new swiper_core_Swiper(".object-page__bigslider", {
...
***************************************************************************** */
        ...
        window.addEventListener("load", (function(e) {
            ...
            if (document.querySelector(".first-row")) {
                const breakpointChecker = function() {
                    if (breakpoint.matches === true) {
                        document.querySelectorAll(".first-row__bottom").forEach((element => {
                            if (!element.classList.contains("_active")) element.hidden = true;
                        }));
                        document.querySelectorAll(".first-row__name").forEach((element => {
                            if (!element.classList.contains("_active")) element.hidden = true;
                        }));
            ...
            document.addEventListener("click", (function(e) {
                const el = e.target;
                if (el.closest(".first-row__arrow") && breakpoint.matches === true) {
                    if (!el.closest(".first-row").querySelector(".first-row__descs").classList.contains("_active")) el.closest(".first-row").querySelector(".first-row__descs").classList.add("_active"); else setTimeout((() => {
                        el.closest(".first-row").querySelector(".first-row__descs").classList.remove("_active");
                    }), 500);
                    if (!el.closest(".first-row").querySelector(".first-row__bottom").classList.contains("_active")) el.closest(".first-row").querySelector(".first-row__bottom").classList.add("_active"); else setTimeout((() => {
                        el.closest(".first-row").querySelector(".first-row__bottom").classList.remove("_active");
                    }), 500);
                    if (!el.closest(".first-row").querySelector(".first-row__name").classList.contains("_active")) el.closest(".first-row").querySelector(".first-row__name").classList.add("_active"); else setTimeout((() => {
                        el.closest(".first-row").querySelector(".first-row__name").classList.remove("_active");
                    }), 500);
                    el.closest(".first-row__arrow").classList.toggle("_active");
                    _slideToggle(el.closest(".first-row").querySelector(".first-row__descs"), 500);
                    _slideToggle(el.closest(".first-row").querySelector(".first-row__bottom"), 500);
                    _slideToggle(el.closest(".first-row").querySelector(".first-row__name"), 500);
                }
                if (el.closest(".first-row__arrow") && breakpoint.matches === false) {
                    if (!el.closest(".first-row").querySelector(".first-row__descs").classList.contains("_active")) el.closest(".first-row").querySelector(".first-row__descs").classList.add("_active"); else if (el.closest(".first-row").querySelector(".first-row__descs").classList.contains("_active")) setTimeout((() => {
                        el.closest(".first-row").querySelector(".first-row__descs").classList.remove("_active");
                    }), 500);
                    if (!el.closest(".first-row").querySelector(".first-row__bottom").classList.contains("_active")) el.closest(".first-row").querySelector(".first-row__bottom").classList.add("_active"); else setTimeout((() => {
                        el.closest(".first-row").querySelector(".first-row__bottom").classList.remove("_active");
                ...
                if (document.querySelector(".search-form__content._active") && !el.closest(".search-form")) document.querySelectorAll(".search-form__content._active").forEach((element => {
                    element.classList.remove("_active");
                }));
            }));
            if (document.querySelector(".search-form__input")) document.addEventListener("input", (function(e) {
                const el = e.target;
                if (el.closest(".search-form__input")) if (el.closest(".search-form").querySelector(".search-form__content")) el.closest(".search-form").querySelector(".search-form__content").classList.add("_active");
            }));
        }));
        window["FLS"] = false;
        isWebp();
