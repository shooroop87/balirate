							...
							<div class="article">
								<div class="crumbs">
									<div class="crumbs__container">
										...
										<a href="<?=get_permalink(2072);?>" class="crumbs__link">Статьи</a>
        ...
        <div class="news__container">
          ...
          <? $k=0;?>
                <?php while (have_posts()) : ?>
                  <? $k++; if ($k==1) {  get_template_part( 'templates/stati_big',null,the_post() ); }  else  { get_template_part( 'templates/null',null,the_post() ); }?>
                   <?php endwhile; ?>
           <? $k=0;?>
           <div class="news__slidercont slidercont">
            <div class="news__slider swiper">
              <div class="news__wrapper swiper-wrapper">
                <?php while (have_posts()) : ?>
                  <? $k++; if ($k>1) {  get_template_part( 'templates/stati_prev',null,the_post() ); }  else  { get_template_part( 'templates/null',null,the_post() ); }?>
                   <?php endwhile; ?>
                </div>
            </div>
