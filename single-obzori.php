        ...
        <div class="news__container">
          ...
          <?php $k=0;?>
                <?php while (have_posts()) : ?>
                  <?php $k++; if ($k==1) {  get_template_part( 'templates/obzor_big',null,the_post() ); }  else  { get_template_part( 'templates/null',null,the_post() ); }?>
                   <?php endwhile; ?>
           <?php $k=0;?>
           <div class="news__slidercont slidercont">
            <div class="news__slider swiper">
              <div class="news__wrapper swiper-wrapper">
                <?php while (have_posts()) : ?>
                  <?php $k++; if ($k>1) {  get_template_part( 'templates/obzor_prev',null,the_post() ); }  else  { get_template_part( 'templates/null',null,the_post() ); }?>
                   <?php endwhile; ?>
                </div>
            </div>
